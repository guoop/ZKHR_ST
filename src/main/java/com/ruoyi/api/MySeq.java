...
public class MySeq {
	...
	private static String task_seq_prefix = "SO";
	private static String goods_seq_prefix = "G";
	...
	public static String getTask() {
		...
		return task_seq_prefix+sfd.format(new Date());
	}
	public static String getGoodsOrderId() {
		return getSeq(goods_seq_prefix, pay_seq);
	}
	...
	public static String getSequece() {
		return String.format("%s%06d", getSeqString(), (int) refund_seq.getAndIncrement() % 1000000);
	}
